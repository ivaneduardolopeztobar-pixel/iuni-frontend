...
export default function Terms() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
      <SEO title="Términos y Privacidad" description="Términos de uso y política de privacidad de iUNI" />
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="text-3xl font-black mb-2 text-white">Términos de Uso y Privacidad</h1>
        <p className="text-gray-500 text-sm mb-10">Última actualización: Junio 2026</p>
        ...
        <Section title="2. Registro y elegibilidad">
          Para registrarse como estudiante se requiere un correo electrónico institucional
        ...
        <Section title="3. Uso de la plataforma">
          Los usuarios se comprometen a proporcionar información verídica en sus perfiles.
          Está prohibido crear cuentas falsas, publicar ofertas fraudulentas o usar la
        ...
        <Section title="4. Datos personales">
          ...
          nombre, correo electrónico, información académica y profesional. Esta información
          es compartida con empleadores únicamente cuando el estudiante decide postularse
          a una oferta. No vendemos datos personales a terceros.
        </Section>

        <Section title="5. Archivos subidos">
          Los CVs y fotografías subidos a la plataforma son almacenados de forma segura
        ...
        <Section title="7. Propiedad intelectual">
          El contenido, diseño y código de iUNI son propiedad de sus creadores. Los
        ...
        <Section title="8. Limitación de responsabilidad">
          ...
          obtención de empleo ni la calidad de los candidatos. No somos responsables
          por acuerdos alcanzados fuera de la plataforma.
        </Section>

        <Section title="9. Contacto">
          Para preguntas sobre estos términos o tu privacidad puedes contactarnos
          respondiendo cualquier email que recibas de iUNI o escribiendo a nuestro
          correo de soporte.
        </Section>

        <div className="mt-10 p-6 bg-white/[0.03] border border-white/10 rounded-2xl">
          <p className="text-gray-400 text-sm text-center">
            Al usar iUNI aceptas estos términos. Si no estás de acuerdo con alguno
