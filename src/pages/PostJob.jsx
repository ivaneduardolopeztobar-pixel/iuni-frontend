  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-2xl mx-auto px-4 py-8">
        <h1 className="text-2xl font-black mb-6">Publicar Nueva Oferta</h1>
        <form onSubmit={handleSubmit} className="bg-gray-950 rounded-2xl p-8 border border-gray-800 space-y-5">
          <F label="Título del empleo *" value={form.title} onChange={v => set('title', v)} required />
          <div>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <F label="Nivel mínimo de estudios" value={form.minEducation} onChange={v => set('minEducation', v)} />
            <F label="Habilidades técnicas" value={form.technicalSkills} onChange={v => set('technicalSkills', v)} />
          ...
          <F label="Compensación / Salario" value={form.salary} onChange={v => set('salary', v)} placeholder="Ej: $400 - $600 / mes" />
          <button
